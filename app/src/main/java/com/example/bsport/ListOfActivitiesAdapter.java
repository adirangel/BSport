...
public class ListOfActivitiesAdapter extends RecyclerView.Adapter<ListOfActivitiesAdapter.MyViewHolder> {
    ...
    public ListOfActivitiesAdapter(ArrayList<String> My_name_activity,ArrayList<String> My_activity_type,ArrayList<String> My_game_date,ArrayList<String> My_location) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView type, name, game_date, location;// init the item view's
